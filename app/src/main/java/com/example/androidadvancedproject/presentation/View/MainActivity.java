...
import com.example.androidadvancedproject.presentation.MainScreenViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent serviceIntent = new Intent(this, LodgeService.class);
    ...
    protected void onDestroy() {
        super.onDestroy();
        Intent serviceIntent = new Intent(this, LodgeService.class);
        serviceIntent.putExtra(LodgeService.TYPE_KEY, LodgeService.TYPE_BASIC);
