...
public class LodgeLoadingView extends View {
    ...
    private final boolean callOnDraw = true;

    public LodgeLoadingView(Context context) {
        super(context);
        initialize(context, null);
    }

    public LodgeLoadingView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initialize(context, attrs);
    }

    public LodgeLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initialize(context, attrs);
    }

    private void initialize(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.LodgeLoadingView);
        int valueColor = typedArray.getColor(R.styleable.LodgeLoadingView_loadingColor,
